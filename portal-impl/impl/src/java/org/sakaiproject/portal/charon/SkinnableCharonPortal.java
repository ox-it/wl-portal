...
public class SkinnableCharonPortal extends HttpServlet implements Portal
{
			...
			ToolConfiguration placement) throws IOException
	{
		...
		String resetActionUrl = PortalStringUtil.replaceFirst(toolUrl, toolUrlPrefix,
				toolUrlPrefix+ "-reset")
				+ "?panel=Main";
			...
			String skin, HttpServletRequest request)
	{
		...
		rcontext.put("shortUrlEnabled", ServerConfigurationService.getBoolean("shortenedurl.portal.enabled", false));
